      ...
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          if (action.data) {
            ...
            if (!result.disabled.includes(hostname)) {
              result.disabled.push(hostname);
            }
          }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch(settings.SHEPHERD_URL);
              ...
              case 6:
                ...
                newSettings.disabled = _toConsumableArray(new Set((newSettings.disabled || []).concat(disabled || [])));
    ...
    value: function init() {
      ...
      return new Promise(function (resolve, reject) {
        for (var i = 0; i < appModules.length; i++) {
          loadedModules.unshift(appModules[i].init());
        }
...
AppBootstrap.init().then(function () {
  ...
  chrome.webRequest.onBeforeSendHeaders.addListener(function (details) {
    ...
    if (!((_Configuration$appSet = Configuration.appSettings) !== null && _Configuration$appSet !== void 0 && (_Configuration$appSet2 = _Configuration$appSet.disabled) !== null && _Configuration$appSet2 !== void 0 && _Configuration$appSet2.includes(hostname))) {
      ...
      headers.forEach(function (h) {
        ...
        if (!currentProfile.OmitHeaders || !currentProfile.OmitHeaders.includes(h.name)) {
          // If the header should not be overridden
...
function updateStatus() {
  chrome.tabs.query({
    ...
    if (tabs[0].url) {
      var _Configuration$appSet3, _Configuration$appSet4;

      var url = new URL(tabs[0].url);

      if ((_Configuration$appSet3 = Configuration.appSettings) !== null && _Configuration$appSet3 !== void 0 && (_Configuration$appSet4 = _Configuration$appSet3.disabled) !== null && _Configuration$appSet4 !== void 0 && _Configuration$appSet4.includes(url.hostname)) {
