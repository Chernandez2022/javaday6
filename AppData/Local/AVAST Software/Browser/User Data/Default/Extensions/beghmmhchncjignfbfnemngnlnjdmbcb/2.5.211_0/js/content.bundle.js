...
var functionsHooks = function functionsHooks(_ref) {
  ...
  window[funcPrefix] = (_window$funcPrefix = {}, _window$funcPrefix[HookedFunctionsMap.Canvas] = function (_ref2, originalArgs) {
    ...
    if (arr === 3415) return 0;else if (arr === 3414) return 24;else if (arr === 36348) return 30;else if (arr === 7936) return "WebKit";else if (arr === 37445) return "Google Inc."; // UNMASKED_VENDOR
    else if (arr === 7937) return "WebKit WebGL";else if (arr === 3379) return randoms.number([14, 15]);else if (arr === 36347) return randoms.number([12, 13]);else if (arr === 34076) return randoms.number([14, 15]);else if (arr === 34024) return randoms.number([14, 15]);else if (arr === 3386) return randoms["int"]([13, 14, 15]);else if (arr === 3413) return randoms.number([1, 2, 3, 4]);else if (arr === 3412) return randoms.number([1, 2, 3, 4]);else if (arr === 3411) return randoms.number([1, 2, 3, 4]);else if (arr === 3410) return randoms.number([1, 2, 3, 4]);else if (arr === 34047) return randoms.number([1, 2, 3, 4]);else if (arr === 34930) return randoms.number([1, 2, 3, 4]);else if (arr === 34921) return randoms.number([1, 2, 3, 4]);else if (arr === 35660) return randoms.number([1, 2, 3, 4]);else if (arr === 35661) return randoms.number([4, 5, 6, 7, 8]);else if (arr === 36349) return randoms.number([10, 11, 12, 13]);else if (arr === 33902) return randoms["float"]([0, 10, 11, 12, 13]);else if (arr === 33901) return randoms["float"]([0, 10, 11, 12, 13]);else if (arr === 37446) return randoms.randomArrValue(["Graphics", "HD Graphics", "Intel(R) HD Graphics"]); // UNMASKED_RENDERER
    else if (arr === 7938) return randoms.randomArrValue(["WebGL 1.0", "WebGL 1.0 (OpenGL)", "WebGL 1.0 (OpenGL Chromium)"]); // GL_VERSION
    else if (arr === 35724) return randoms.randomArrValue(["WebGL", "WebGL GLSL", "WebGL GLSL ES", "WebGL GLSL ES (OpenGL Chromium"]); // SHADING_LANGUAGE_VERSION

    return proto.call(this, arr);
    ...
    var index = Math.floor(Math.random() * arr[1].length);
    var noise = arr[1][index] !== undefined ? 0.1 * Math.random() * arr[1][index] : 0;
    arr[1][index] = arr[1][index] + noise;
...
ExtensionStorage.getSync(app/* StorageKeys.AppSettings.KEY */.BU.AppSettings.KEY).then(function (config) {
  ...
  var isDisabled = config.disabled.includes(url) || !config.isActive;
